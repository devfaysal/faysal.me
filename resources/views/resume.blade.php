...
<head>
    ...
    <!-- Styles -->
    <link href="{{ mix('css/tailwind.css') }}" type="text/css" rel="stylesheet" media="all">
    ...
    <meta property='og:url' content="http://faysal.me/resume">
...
<body>
    <div class="max-w-2xl mx-auto print:mt-0 mt-6">
        <div class="flex mb-6">
            <div class="w-1/4 mt-2 pr-6">
                <img class="w-32 h-32 block ml-auto" src="https://avatars3.githubusercontent.com/u/16212149" alt="">
            </div>
            <div class="w-3/4">
                <div class="mb-1">
                    <h1 class="text-3xl text-gray-700 font-extrabold leading-tight">Faysal Ahamed</h1>
                    <p class="text-lg text-gray-600 font-bold">Full-stack Web Developer</p>
                </div>
