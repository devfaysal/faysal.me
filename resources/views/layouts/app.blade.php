...
<body class="bg-gray-200 leading-tight">
    <div class="max-w-2xl mx-auto px-6">
            ...
            <div class="sm:flex sm:items-center">
                ...
                <div class="sm:ml-6">
                    <a href="/" class="no-underline text-gray-700">
                        <h1 class="uppercase font-bold text-4xl mb-1 text-center sm:text-left">Faysal Ahamed</h1>
                    </a>
                    ...
                    <div class="flex justify-center text-center md:justify-start">
                        <a target="_blank" href="https://github.com/devfaysal" class="text-gray-500 hover:text-github m-2 no-underline">
        ...
        <nav class="flex justify-around flex-wrap border-gray-400 border-t border-b mb-8">
            <a href="/" class="m-2 inline-block text-gray-700 uppercase tracking-wide no-underline hover:underline hover:text-gray-600">Home</a>
            <a href="/about" class="m-2 inline-block text-gray-700 uppercase tracking-wide no-underline hover:underline hover:text-gray-600">About</a>
            <a href="/blog" class="m-2 inline-block text-gray-700 uppercase tracking-wide no-underline hover:underline hover:text-gray-600">Blog</a>
        </nav>
        <main>
            @yield('content')
        </main>
